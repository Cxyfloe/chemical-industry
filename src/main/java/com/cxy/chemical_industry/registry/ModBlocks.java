...
import com.cxy.chemical_industry.block.AirCompressorBlock;
import com.cxy.chemical_industry.block.ElectrolyzerBlock;
import com.cxy.chemical_industry.block.FluidizedBedBlock;
import com.cxy.chemical_industry.block.ReactiveMetalBlock;
...
public class ModBlocks {
    ...
    public static final DeferredBlock<com.cxy.chemical_industry.block.CondenserPipeBlock> CONDENSER_PIPE = BLOCKS.register(
            "condenser_pipe", com.cxy.chemical_industry.block.CondenserPipeBlock::new);

    // ---------- 作物 ----------

    /** 罂粟 — 开花植物，3 阶段生长，成熟收获罂粟果实（无 BlockItem，只能种子种植） */
    public static final DeferredBlock<com.cxy.chemical_industry.block.OpiumPoppyBlock> OPIUM_POPPY = BLOCKS.register(
            "opium_poppy", com.cxy.chemical_industry.block.OpiumPoppyBlock::new);
