...
import com.cxy.chemical_industry.screen.FluidizedBedMenu;
...
public class ModMenus {
    ...
    public static final Supplier<MenuType<FluidizedBedMenu>> FLUIDIZED_BED_MENU = MENUS.register(
            ...
            () -> IMenuTypeExtension.create((id, inv, data) -> {
                ...
                if (be instanceof com.cxy.chemical_industry.block_entity.FluidizedBedBlockEntity e)
                    return new FluidizedBedMenu(id, inv, e, e.dataAccess);
                return null;
            })
    );

    public static final Supplier<MenuType<com.cxy.chemical_industry.screen.ElectrolyzerMenu>> ELECTROLYZER_MENU = MENUS.register(
            "electrolyzer_menu",
            () -> IMenuTypeExtension.create((id, inv, data) -> {
                ...
                if (be instanceof com.cxy.chemical_industry.block_entity.ElectrolyzerBlockEntity e)
                    return new com.cxy.chemical_industry.screen.ElectrolyzerMenu(id, inv, e, e.data);
                return null;
            })
    );
