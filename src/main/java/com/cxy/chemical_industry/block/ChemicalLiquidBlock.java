...
public class ChemicalLiquidBlock extends LiquidBlock {
    ...
    private void reactWithNeighbors(BlockState state, Level level, BlockPos pos) {
        for (Direction dir : Direction.values()) {
            ...
            if (acidWater) {
                ...
                // 成就：第一次硫酸遇水爆炸
                com.cxy.chemical_industry.event.AdvancementHelper.grantNearby(level, pos, "acid_into_water", "acid_water");
                return;
            }
    ...
    private static void applyCorrosion(LivingEntity living, int amplifier) {
        living.addEffect(new net.minecraft.world.effect.MobEffectInstance(
                com.cxy.chemical_industry.registry.ModEffects.corrosionHolder(), 100, amplifier));
    }
