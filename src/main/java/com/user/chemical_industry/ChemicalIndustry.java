package com.user.chemical_industry;
...
import com.user.chemical_industry.screen.ElectrolyzerScreen;
import com.user.chemical_industry.screen.FluidizedBedScreen;
    ...
    public ChemicalIndustry(IEventBus modEventBus) {
        ...
        if (net.neoforged.fml.loading.FMLEnvironment.dist.isClient()) {
            net.createmod.ponder.foundation.PonderIndex.addPlugin(
                    new com.user.chemical_industry.ponder.ChemicalPonderPlugin());
        }
    }
            ...
            event.enqueueWork(() -> {
                net.minecraft.client.renderer.item.ItemProperties.register(
                        ...
                        (stack, level, entity, seed) -> {
                            ...
                            return com.user.chemical_industry.item.ThermometerItem.getTemperatureValue(level, entity.blockPosition());
                        });
            });
        }
    }
