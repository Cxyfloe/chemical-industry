                        ...
                        if (isGasFluid(key)) {
                            ...
                            if (!drained.isEmpty()) {
                                ...
                                if (key.endsWith("rare_gas"))
                                    com.user.chemical_industry.event.AdvancementHelper.grantNearby(level, pos, "rare_gas", "rare");
            ...
            for (LivingEntity e : sl.getEntitiesOfClass(LivingEntity.class,
                ...
                if (corrode) {
                    ...
                    e.addEffect(new net.minecraft.world.effect.MobEffectInstance(
                            com.user.chemical_industry.registry.ModEffects.corrosionHolder(), 100, 0));
                }
                if (poison)
                    e.addEffect(new net.minecraft.world.effect.MobEffectInstance(
