...
import com.user.chemical_industry.item.GasCanisterItem;
import com.user.chemical_industry.item.ThermometerItem;
import com.user.chemical_industry.item.TooltipBlockItem;
...
public class ModItems {
     ...
     */
    public static final DeferredItem<com.user.chemical_industry.item.OpiumPoppyFruitItem> OPIUM_POPPY_FRUIT = ITEMS.register(
            "opium_poppy_fruit",
            () -> new com.user.chemical_industry.item.OpiumPoppyFruitItem(new Item.Properties()
     ...
     * 效果比果实强、副作用也更久
     */
    public static final DeferredItem<com.user.chemical_industry.item.OpiumItem> OPIUM = ITEMS.register(
            "opium",
            () -> new com.user.chemical_industry.item.OpiumItem(new Item.Properties()
                    .food(new FoodProperties.Builder()
    ...
    public static final DeferredItem<com.user.chemical_industry.item.FluidizedBedControllerItem> FLUIDIZED_BED_CONTROLLER = ITEMS.register(
            "fluidized_bed_controller",
            com.user.chemical_industry.item.FluidizedBedControllerItem::new
    );
    /** 电解槽 */
